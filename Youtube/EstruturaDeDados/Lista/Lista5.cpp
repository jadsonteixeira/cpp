...
int main() {
    ...
    cout << "Tamanho da lista2: " << lista2.size() << endl;
    ...
    lista.merge(lista2); // mescla os elementos da lista com os elementos da lista2
    ...
    // lista2 está vazia porque os elementos agora foram para a lista
